...
router.post('/', auth_middleware_1.authMiddleware, (0, rbac_middleware_1.rbacMiddleware)(['SUPER_ADMIN', 'ORG_ADMIN', 'SCHOOL_ADMIN']), users_controller_1.createUser);
router.put('/:id', auth_middleware_1.authMiddleware, (0, rbac_middleware_1.rbacMiddleware)(['SUPER_ADMIN', 'ORG_ADMIN', 'SCHOOL_ADMIN']), users_controller_1.updateUser);
router.patch('/:id', auth_middleware_1.authMiddleware, (0, rbac_middleware_1.rbacMiddleware)(['SUPER_ADMIN', 'ORG_ADMIN', 'SCHOOL_ADMIN']), users_controller_1.updateUser);
